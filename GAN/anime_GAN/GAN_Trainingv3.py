...
#data_dir = "../../corpus/face/*.jpg"
#data_dir = "/home/alvin/cei/notebook_home/ai_lab_image/corpus/faces/*.jpg"
#data_dir  = "./anime_planet_ou/*.png"
data_dir  = "../../corpus/faces64/*.jpg"
...
#print('GAN_inp => \t' + str(GAN_inp.shape))
...
for step in range(num_steps): 
    ...
    #print('real =>\t' + str(real_data_X.shape))
    #print('fake =>\t' + str(fake_data_X.shape))
